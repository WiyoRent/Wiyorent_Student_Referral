...
import { User, Mail, Lock, GraduationCap, Phone, AlertCircle, UserPlus } from "lucide-react";
        ...
        <div className="rounded-2xl shadow-xl p-8 space-y-6" style={{ backgroundColor: '#010101' }}>
          ...
          <div className="text-center space-y-2">
            <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center" style={{ backgroundColor: '#EDB508' }}>
              <UserPlus className="w-8 h-8" style={{ color: '#010101' }} />
            </div>
            <h1 className="text-3xl font-bold" style={{ color: '#FAFAF7' }}>Create account</h1>
            <p style={{ color: '#999' }}>Sign up to get started</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-2">
              <label htmlFor="name" className="block text-sm font-medium" style={{ color: '#FAFAF7' }}>
                Full name
              </label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: '#666' }} />
                <input
                  id="name"
                  name="name"
                  type="text"
            ...
            <div className="space-y-2">
              <label htmlFor="university" className="block text-sm font-medium" style={{ color: '#FAFAF7' }}>
                University
              </label>
              <div className="relative">
                <GraduationCap className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: '#666' }} />
                <input
                  id="university"
                  name="university"
                  type="text"
            ...
            <div className="space-y-2">
              <label htmlFor="phone" className="block text-sm font-medium" style={{ color: '#FAFAF7' }}>
                Phone
              </label>
              <div className="relative">
                <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: '#666' }} />
                <input
                  id="phone"
                  name="phone"
                  type="tel"
            ...
            <button
              type="submit"
              className="w-full font-semibold py-3 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg mt-6"
              style={{ 
          ...
          <div className="text-center pt-4 border-t" style={{ borderColor: '#333' }}>
            <p style={{ color: '#999' }}>
              ...
              <Link href="/login" className="font-semibold transition-colors" style={{ color: '#EDB508' }}>
                Log in
              </Link>
            </p>
          </div>
